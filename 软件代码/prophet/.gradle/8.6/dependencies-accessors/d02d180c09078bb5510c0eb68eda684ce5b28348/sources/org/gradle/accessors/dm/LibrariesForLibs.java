...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxRoomLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>androidxRoomRoomCompiler2</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class AndroidxRoomRoomLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>compiler4</b> with <b>androidx.room:room-compiler</b> coordinates and
         * with version reference <b>androidxRoomRoomCompiler2</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCompiler4() {
            return create("androidx.room.room.compiler4");
        }

        /**
         * Dependency provider for <b>ktx</b> with <b>androidx.room:room-ktx</b> coordinates and
         * with version reference <b>androidxRoomKtx</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getKtx() {
            return create("androidx.room.room.ktx");
        }

        /**
         * Dependency provider for <b>rxjava2</b> with <b>androidx.room:room-rxjava2</b> coordinates and
         * with version reference <b>androidxRoomRxjava2</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getRxjava2() {
            return create("androidx.room.room.rxjava2");
        }
        ...
        public Provider<MinimalExternalModuleDependency> getRxjava3() {
            return create("androidx.room.room.rxjava3");
        }
    ...
    public static class OrgEclipsePahoLibraryAccessors extends SubDependencyFactory {
        ...
        private final OrgEclipsePahoMqttv5LibraryAccessors laccForOrgEclipsePahoMqttv5LibraryAccessors = new OrgEclipsePahoMqttv5LibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>org.eclipse.paho.mqttv5</b>
         */
        public OrgEclipsePahoMqttv5LibraryAccessors getMqttv5() {
            return laccForOrgEclipsePahoMqttv5LibraryAccessors;
        }
    ...
    public static class OrgEclipsePahoMqttv5LibraryAccessors extends SubDependencyFactory {

        public OrgEclipsePahoMqttv5LibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>client</b> with <b>org.eclipse.paho:org.eclipse.paho.mqttv5.client</b> coordinates and
         * with version reference <b>orgEclipsePahoMqttv5Client</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getClient() {
            return create("org.eclipse.paho.mqttv5.client");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidxRoomKtx</b> with value <b>2.6.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAndroidxRoomKtx() { return getVersion("androidxRoomKtx"); }

        /**
         * Version alias <b>androidxRoomRoomCompiler2</b> with value <b>2.6.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAndroidxRoomRoomCompiler2() { return getVersion("androidxRoomRoomCompiler2"); }

        /**
         * Version alias <b>androidxRoomRxjava2</b> with value <b>2.6.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAndroidxRoomRxjava2() { return getVersion("androidxRoomRxjava2"); }
        ...
        /**
         * Version alias <b>hiltAndroidGradlePlugin</b> with value <b>2.51</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>hiltAndroidVersion</b> with value <b>2.40.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>orgEclipsePahoClientMqttv3</b> with value <b>1.2.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>orgEclipsePahoMqttv5Client</b> with value <b>1.2.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getOrgEclipsePahoMqttv5Client() { return getVersion("orgEclipsePahoMqttv5Client"); }
        ...
        /**
         * Version alias <b>supportV4</b> with value <b>30.4.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
